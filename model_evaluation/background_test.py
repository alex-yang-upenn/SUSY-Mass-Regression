...
def main():
    ...
    create_2var_histogram_with_marker(
        ...
        filename=os.path.join(config["ROOT_DIR"], "model_evaluation", "background_plots/gnn_baseline_v_finetune.png")
    )
    ...
    create_2var_histogram_with_marker(
        ...
        title=f"Background Event Predictions",
        x_label="Predicted Mass (GeV / c^2)",
        filename=os.path.join(config["ROOT_DIR"], "model_evaluation", "background_plots/finetune_v_no_finetune.png")
    )
    ...
    create_2var_histogram_with_marker(
        ...
        title=f"Background Event Predictions",
        x_label="Predicted Mass (GeV / c^2)",
        filename=os.path.join(config["ROOT_DIR"], "model_evaluation", "background_plots/transformed_training.png")
    )
