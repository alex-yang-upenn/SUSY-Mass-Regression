...
def main():
    ...
    data = np.load(
        os.path.join(config["PROCESSED_DATA_BACKGROUND_DIRECTORY"], "test_TbqqTblv.npz")
    )
    X_background = data["X"]
    ...
    create_2var_histogram_with_marker(
        ...
        filename=os.path.join(
            config["ROOT_DIR"],
            "model_evaluation",
            "background_plots/gnn_baseline_v_finetune.png",
        ),
    )
    ...
    create_2var_histogram_with_marker(
        ...
        filename=os.path.join(
            config["ROOT_DIR"],
            "model_evaluation",
            "background_plots/finetune_v_no_finetune.png",
        ),
    )
    ...
    create_2var_histogram_with_marker(
        ...
        filename=os.path.join(
            config["ROOT_DIR"],
            "model_evaluation",
            "background_plots/transformed_training.png",
        ),
    )
